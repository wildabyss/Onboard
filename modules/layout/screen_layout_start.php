			...
			<div class="content_column_wrapper" id="column_wrapper_left">
				<ul>
					<li class="button_middle"><a id="button_home" href="/home"
						class="<?php if ($_PAGE_TITLE==Utilities::PAGE_HOME) echo "selected"?>">Home</a></li>
					...
					<li><a id="button_list" href="/browse"
						class="<?php if ($_PAGE_TITLE==Utilities::PAGE_BROWSE) echo "selected"?>">Browse Activities</a></li>
				</ul>
			</div>
		</div>