 ...
 *
 * @method     ChildActivityQuery leftJoinActivityCategoryAssociation($relationAlias = null) Adds a LEFT JOIN clause to the query using the ActivityCategoryAssociation relation
...
abstract class ActivityQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'onboard', $modelName = '\\Activity', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name FROM activity WHERE id = :p0';
        try {
    ...
    public function filterByActivityCategoryAssociation($activityCategoryAssociation, $comparison = null)
    {
        if ($activityCategoryAssociation instanceof \ActivityCategoryAssociation) {
            return $this
                ->addUsingAlias(ActivityTableMap::COL_ID, $activityCategoryAssociation->getActivityId(), $comparison);
    ...
    public function filterByDiscussion($discussion, $comparison = null)
    {
        if ($discussion instanceof \Discussion) {
            return $this
                ->addUsingAlias(ActivityTableMap::COL_ID, $discussion->getActivityId(), $comparison);
