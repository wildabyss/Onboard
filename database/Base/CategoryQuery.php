 ...
 *
 * @method     ChildCategoryQuery leftJoinActivityCategoryAssociation($relationAlias = null) Adds a LEFT JOIN clause to the query using the ActivityCategoryAssociation relation
 * @method     ChildCategoryQuery rightJoinActivityCategoryAssociation($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ActivityCategoryAssociation relation
 * @method     ChildCategoryQuery innerJoinActivityCategoryAssociation($relationAlias = null) Adds a INNER JOIN clause to the query using the ActivityCategoryAssociation relation
 *
 * @method     \ActivityCategoryAssociationQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CategoryQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'onboard', $modelName = '\\Category', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \ActivityCategoryAssociation object
     *
     * @param \ActivityCategoryAssociation|ObjectCollection $activityCategoryAssociation  the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildCategoryQuery The current query, for fluid interface
     */
    public function filterByActivityCategoryAssociation($activityCategoryAssociation, $comparison = null)
    {
        if ($activityCategoryAssociation instanceof \ActivityCategoryAssociation) {
            return $this
                ->addUsingAlias(CategoryTableMap::COL_ID, $activityCategoryAssociation->getCategoryId(), $comparison);
        } elseif ($activityCategoryAssociation instanceof ObjectCollection) {
            return $this
                ->useActivityCategoryAssociationQuery()
                ->filterByPrimaryKeys($activityCategoryAssociation->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByActivityCategoryAssociation() only accepts arguments of type \ActivityCategoryAssociation or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the ActivityCategoryAssociation relation
     *
     ...
     * @return $this|ChildCategoryQuery The current query, for fluid interface
     */
    public function joinActivityCategoryAssociation($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('ActivityCategoryAssociation');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'ActivityCategoryAssociation');
        }
    ...
    /**
     * Use the ActivityCategoryAssociation relation ActivityCategoryAssociation object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \ActivityCategoryAssociationQuery A secondary query class using the current class as primary query
     */
    public function useActivityCategoryAssociationQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinActivityCategoryAssociation($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'ActivityCategoryAssociation', '\ActivityCategoryAssociationQuery');
    }
