...
class CategoryTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_ID, CategoryTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_ID => 0, CategoryTableMap::COL_NAME => 1, ),
    ...
    {
        $this->addRelation('ActivityCategoryAssociation', '\\ActivityCategoryAssociation', RelationMap::ONE_TO_MANY, array('id' => 'category_id', ), 'CASCADE', null, 'ActivityCategoryAssociations');
    } // buildRelations()
    /**
