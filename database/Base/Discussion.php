...
*/
abstract class Discussion implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\DiscussionTableMap';
    ...
    /**
     * Initializes internal state of Base\Discussion object.
     */
    ...
    /**
     * Compares this with another <code>Discussion</code> instance.  If
     * <code>obj</code> is an instance of <code>Discussion</code>, delegates to
     * <code>equals(Discussion)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Discussion The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[DiscussionTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[DiscussionTableMap::COL_NAME] = true;
        }
    ...
    public function setActivityId($v)
    {
        ...
        if ($this->activity_id !== $v) {
            $this->activity_id = $v;
            $this->modifiedColumns[DiscussionTableMap::COL_ACTIVITY_ID] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[DiscussionTableMap::COL_STATUS] = true;
        }
    ...
    public function setDateCreated($v)
    {
        ...
        if ($this->date_created !== null || $dt !== null) {
            if ($dt !== $this->date_created) {
                $this->date_created = $dt;
                $this->modifiedColumns[DiscussionTableMap::COL_DATE_CREATED] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DiscussionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DiscussionTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDiscussionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Discussion::setDeleted()
     * @see Discussion::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDiscussionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DiscussionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DiscussionTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(DiscussionTableMap::COL_NAME)) {
    ...
    {
        $pos = DiscussionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Discussion'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Discussion'][$this->hashCode()] = true;
        $keys = DiscussionTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DiscussionTableMap::COL_ID)) {
            $criteria->add(DiscussionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(DiscussionTableMap::COL_NAME)) {
            $criteria->add(DiscussionTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(DiscussionTableMap::COL_ACTIVITY_ID)) {
    ...
    {
        $criteria = ChildDiscussionQuery::create();
        $criteria->add(DiscussionTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Discussion (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Discussion Clone of current object.
     * @throws PropelException
     */
    ...
    public function getActivity(ConnectionInterface $con = null)
    {
        if ($this->aActivity === null && ($this->activity_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aActivity->addDiscussions($this);
             */
        }
     ...
     * If this ChildDiscussion is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildDiscussion The current object (for fluent API support)
     */
    public function setDiscussionUserAssociations(Collection $discussionUserAssociations, ConnectionInterface $con = null)
    {
        ...
        foreach ($discussionUserAssociationsToDelete as $discussionUserAssociationRemoved) {
            $discussionUserAssociationRemoved->setDiscussion(null);
        }
    ...
    protected function doAddDiscussionUserAssociation(ChildDiscussionUserAssociation $discussionUserAssociation)
    {
        ...
        $discussionUserAssociation->setDiscussion($this);
    }
    ...
    public function removeDiscussionUserAssociation(ChildDiscussionUserAssociation $discussionUserAssociation)
    {
        if ($this->getDiscussionUserAssociations()->contains($discussionUserAssociation)) {
            ...
            $discussionUserAssociation->setDiscussion(null);
        }
     ...
     * Otherwise if this Discussion is new, it will return
     * an empty collection; or if this Discussion has previously
     * been saved, it will retrieve related DiscussionUserAssociations from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Discussion.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(DiscussionTableMap::DEFAULT_STRING_FORMAT);
    }
