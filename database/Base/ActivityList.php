...
/**
 * Base class that represents a row from the 'activity_list' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class ActivityList implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ActivityListTableMap';
    ...
    /**
     * Initializes internal state of Base\ActivityList object.
     */
    ...
    /**
     * Compares this with another <code>ActivityList</code> instance.  If
     * <code>obj</code> is an instance of <code>ActivityList</code>, delegates to
     * <code>equals(ActivityList)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ActivityList The current object, for fluid interface
     */
     ...
     * @return $this|\ActivityList The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ActivityListTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[ActivityListTableMap::COL_NAME] = true;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[ActivityListTableMap::COL_USER_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ActivityListTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ActivityListTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ActivityListTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ActivityListTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ActivityList'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildActivityListQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ActivityList::setDeleted()
     * @see ActivityList::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildActivityListQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ActivityListTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ActivityListTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ActivityListTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ActivityListTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ActivityListTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(ActivityListTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'user_id';
        }

        $sql = sprintf(
            'INSERT INTO activity_list (%s) VALUES (%s)',
    ...
    {
        $pos = ActivityListTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ActivityList'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ActivityList'][$this->hashCode()] = true;
        $keys = ActivityListTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
    ...
    {
        $criteria = new Criteria(ActivityListTableMap::DATABASE_NAME);

        if ($this->isColumnModified(ActivityListTableMap::COL_ID)) {
            $criteria->add(ActivityListTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ActivityListTableMap::COL_NAME)) {
            $criteria->add(ActivityListTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(ActivityListTableMap::COL_USER_ID)) {
            $criteria->add(ActivityListTableMap::COL_USER_ID, $this->user_id);
        }
    ...
    {
        $criteria = ChildActivityListQuery::create();
        $criteria->add(ActivityListTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ActivityList (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ActivityList Clone of current object.
     * @throws PropelException
     */
    ...
    public function getUser(ConnectionInterface $con = null)
    {
        if ($this->aUser === null && ($this->user_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addActivityLists($this);
             */
        }
     ...
     * If this ChildActivityList is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildActivityList The current object (for fluent API support)
     */
    public function setActivityListAssociations(Collection $activityListAssociations, ConnectionInterface $con = null)
    {
        ...
        foreach ($activityListAssociationsToDelete as $activityListAssociationRemoved) {
            $activityListAssociationRemoved->setActivityList(null);
        }
    ...
    protected function doAddActivityListAssociation(ChildActivityListAssociation $activityListAssociation)
    {
        ...
        $activityListAssociation->setActivityList($this);
    }
    ...
    public function removeActivityListAssociation(ChildActivityListAssociation $activityListAssociation)
    {
        if ($this->getActivityListAssociations()->contains($activityListAssociation)) {
            ...
            $activityListAssociation->setActivityList(null);
        }
     ...
     * Otherwise if this ActivityList is new, it will return
     * an empty collection; or if this ActivityList has previously
     * been saved, it will retrieve related ActivityListAssociations from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ActivityList.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildActivityListAssociation[] List of ChildActivityListAssociation objects
     */
    public function getActivityListAssociationsJoinActivity(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildActivityListAssociationQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aUser) {
            $this->aUser->removeActivityList($this);
        }
        $this->id = null;
        $this->name = null;
        $this->user_id = null;
    ...
    {
        return (string) $this->exportTo(ActivityListTableMap::DEFAULT_STRING_FORMAT);
    }
