...
class ActivityUserAssociationTableMap extends TableMap
{
     ...
     */
    const COL_LIST_ID = 'activity_user_assoc.list_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'ActivityId', 'UserId', 'ListId', 'Status', 'DateAdded', 'Alias', 'Description', ),
        self::TYPE_CAMELNAME     => array('id', 'activityId', 'userId', 'listId', 'status', 'dateAdded', 'alias', 'description', ),
        self::TYPE_COLNAME       => array(ActivityUserAssociationTableMap::COL_ID, ActivityUserAssociationTableMap::COL_ACTIVITY_ID, ActivityUserAssociationTableMap::COL_USER_ID, ActivityUserAssociationTableMap::COL_LIST_ID, ActivityUserAssociationTableMap::COL_STATUS, ActivityUserAssociationTableMap::COL_DATE_ADDED, ActivityUserAssociationTableMap::COL_ALIAS, ActivityUserAssociationTableMap::COL_DESCRIPTION, ),
        self::TYPE_FIELDNAME     => array('id', 'activity_id', 'user_id', 'list_id', 'status', 'date_added', 'alias', 'description', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'ActivityId' => 1, 'UserId' => 2, 'ListId' => 3, 'Status' => 4, 'DateAdded' => 5, 'Alias' => 6, 'Description' => 7, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'activityId' => 1, 'userId' => 2, 'listId' => 3, 'status' => 4, 'dateAdded' => 5, 'alias' => 6, 'description' => 7, ),
        self::TYPE_COLNAME       => array(ActivityUserAssociationTableMap::COL_ID => 0, ActivityUserAssociationTableMap::COL_ACTIVITY_ID => 1, ActivityUserAssociationTableMap::COL_USER_ID => 2, ActivityUserAssociationTableMap::COL_LIST_ID => 3, ActivityUserAssociationTableMap::COL_STATUS => 4, ActivityUserAssociationTableMap::COL_DATE_ADDED => 5, ActivityUserAssociationTableMap::COL_ALIAS => 6, ActivityUserAssociationTableMap::COL_DESCRIPTION => 7, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'activity_id' => 1, 'user_id' => 2, 'list_id' => 3, 'status' => 4, 'date_added' => 5, 'alias' => 6, 'description' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ActivityUserAssociationTableMap::COL_LIST_ID);
