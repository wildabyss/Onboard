...
class UserTableMap extends TableMap
{
     ...
     */
    const COL_FB_ID = 'user.fb_id';

    /**
     * the column name for the google_id field
     */
    const COL_GOOGLE_ID = 'user.google_id';
     ...
     */
    const COL_DISPLAY_NAME = 'user.display_name';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'FbId', 'GoogleId', 'Status', 'DateJoined', 'DisplayName', 'Email', 'Phone', ),
        self::TYPE_CAMELNAME     => array('id', 'fbId', 'googleId', 'status', 'dateJoined', 'displayName', 'email', 'phone', ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_ID, UserTableMap::COL_FB_ID, UserTableMap::COL_GOOGLE_ID, UserTableMap::COL_STATUS, UserTableMap::COL_DATE_JOINED, UserTableMap::COL_DISPLAY_NAME, UserTableMap::COL_EMAIL, UserTableMap::COL_PHONE, ),
        self::TYPE_FIELDNAME     => array('id', 'fb_id', 'google_id', 'status', 'date_joined', 'display_name', 'email', 'phone', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'FbId' => 1, 'GoogleId' => 2, 'Status' => 3, 'DateJoined' => 4, 'DisplayName' => 5, 'Email' => 6, 'Phone' => 7, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'fbId' => 1, 'googleId' => 2, 'status' => 3, 'dateJoined' => 4, 'displayName' => 5, 'email' => 6, 'phone' => 7, ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_ID => 0, UserTableMap::COL_FB_ID => 1, UserTableMap::COL_GOOGLE_ID => 2, UserTableMap::COL_STATUS => 3, UserTableMap::COL_DATE_JOINED => 4, UserTableMap::COL_DISPLAY_NAME => 5, UserTableMap::COL_EMAIL => 6, UserTableMap::COL_PHONE => 7, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'fb_id' => 1, 'google_id' => 2, 'status' => 3, 'date_joined' => 4, 'display_name' => 5, 'email' => 6, 'phone' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('fb_id', 'FbId', 'VARCHAR', false, 22, null);
        $this->addColumn('google_id', 'GoogleId', 'VARCHAR', false, 22, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('UserCommunityAssociationRelatedByUserIdRight', '\\UserCommunityAssociation', RelationMap::ONE_TO_MANY, array('id' => 'user_id_right', ), 'CASCADE', null, 'UserCommunityAssociationsRelatedByUserIdRight');
    } // buildRelations()
    /**
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserTableMap::COL_FB_ID);
            $criteria->addSelectColumn(UserTableMap::COL_GOOGLE_ID);
