 ...
 * @method     ChildActivityUserAssociationQuery orderByIsOwner($order = Criteria::ASC) Order by the is_owner column
 *
 ...
 * @method     ChildActivityUserAssociationQuery groupByIsOwner() Group by the is_owner column
 *
 ...
 *
 * @method     ChildActivityUserAssociationQuery leftJoinDiscussionUserAssociation($relationAlias = null) Adds a LEFT JOIN clause to the query using the DiscussionUserAssociation relation
 * @method     ChildActivityUserAssociationQuery rightJoinDiscussionUserAssociation($relationAlias = null) Adds a RIGHT JOIN clause to the query using the DiscussionUserAssociation relation
 * @method     ChildActivityUserAssociationQuery innerJoinDiscussionUserAssociation($relationAlias = null) Adds a INNER JOIN clause to the query using the DiscussionUserAssociation relation
 *
 ...
 * @method     ChildActivityUserAssociation findOneByIsOwner(int $is_owner) Return the first ChildActivityUserAssociation filtered by the is_owner column
 *
 ...
 * @method     ChildActivityUserAssociation[]|ObjectCollection findByIsOwner(int $is_owner) Return ChildActivityUserAssociation objects filtered by the is_owner column
...
abstract class ActivityUserAssociationQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, activity_id, user_id, status, date_added, alias, description, is_owner FROM activity_user_assoc WHERE id = :p0';
        try {
    ...
    public function filterByIsOwner($isOwner = null, $comparison = null)
    {
        if (is_array($isOwner)) {
            ...
            if (isset($isOwner['min'])) {
                $this->addUsingAlias(ActivityUserAssociationTableMap::COL_IS_OWNER, $isOwner['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($isOwner['max'])) {
                $this->addUsingAlias(ActivityUserAssociationTableMap::COL_IS_OWNER, $isOwner['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ActivityUserAssociationTableMap::COL_IS_OWNER, $isOwner, $comparison);
    }
    ...
    public function filterByDiscussionUserAssociation($discussionUserAssociation, $comparison = null)
    {
        if ($discussionUserAssociation instanceof \DiscussionUserAssociation) {
            return $this
                ->addUsingAlias(ActivityUserAssociationTableMap::COL_ID, $discussionUserAssociation->getActivityUserAssociationId(), $comparison);
